...
public:
	...
	bool AddMonster(SkinnedObject* skinnedObject); // 충돌검사 길찾기를 위한 몬스터리스트, 다형성 구현을 위해skinnedObject*에서  GameObject*로
	...
	std::list<SkinnedObject*>&		GetMonsters() { return mMonsters;}
