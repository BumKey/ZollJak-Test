...
void BasicMeshData::SetIndices(ID3D11Device* device, const USHORT* indices, UINT count)
{
...
void BasicMeshData::SetSubsetTable(std::vector<Subset>& subsetTable)
{
	mSubsetTable = subsetTable;
}

void BasicMeshData::Draw(ID3D11DeviceContext* dc, UINT subsetId)
{
    UINT offset = 0;
