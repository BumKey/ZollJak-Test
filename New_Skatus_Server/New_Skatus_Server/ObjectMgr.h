...
public:
	...
	const unordered_map<UINT, SO_InitDesc>		GetPlayers();
	const unordered_map<UINT, SO_InitDesc>&	GetMonsters() { return mMonsters; }
	const vector<BO_InitDesc>& GetAllBasicObjects() { return mObstacles; }
