#ifndef BasicMeshData_H
#define BasicMeshData_H
...
private:
	BasicMeshData(const BasicMeshData& rhs);
	BasicMeshData& operator=(const BasicMeshData& rhs);
...
template <typename VertexType>
void BasicMeshData::SetVertices(ID3D11Device* device, const VertexType* vertices, UINT count)
{
	ReleaseCOM(mVB);
