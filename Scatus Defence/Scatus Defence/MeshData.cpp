...
void MeshData::SetIndices(ID3D11Device* device, const USHORT* indices, UINT count)
{
...
void MeshData::SetSubsetTable(std::vector<Subset>& subsetTable)
{
	mSubsetTable = subsetTable;
}

void MeshData::Draw(ID3D11DeviceContext* dc, UINT subsetId)
{
    UINT offset = 0;
